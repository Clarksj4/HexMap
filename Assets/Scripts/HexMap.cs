...
public class HexMap : MonoBehaviour
{
    ...
    public HexCell this[AxialCoordinate coordinate]
    {
        get
        {
            ...
            return cells[coordinate.GridColumn, coordinate.Z];
        }
    }

    private HexCell[,] cells;

    private float OuterRadius { get { return HexCellPrefab.OuterRadius; } }
    private float OuterDiameter { get { return HexCellPrefab.OuterDiameter; } }
    private float InnerRadius { get { return HexCellPrefab.InnerRadius; } }
    private float InnerDiameter { get { return HexCellPrefab.InnerDiameter; } }
